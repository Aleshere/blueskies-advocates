        ...
        <div ref={ref}>
            <VerticalTimeline>
                ...
                <TimelineElement
                    ...
                    date='November 2008'
                    description='President George W Bush issues Executive Order 13479, emphasizing the importance of implementing NextGen. The order also directs the Secretary of Transportation to establish a support staff for NextGen. Side note: the FAA Administrator was Marion Blakey, who served in 2002-2007. Immediately after retiring, she became CEO at the Aerospace Industries Association (ie lobbyist AIA).'
                />
                <TimelineElement
                    position='right'
                    background='rgb(33,150,243)'
                ...
                <TimelineElement
                    ...
                    date='Spring 2015'
                    description="O'Hare International Airport receives 2 million noise complaints from 44,500 addresses in the first 8 months of 2015. Santa Cruz County, CA, files over 12,000 noise complaints to San Francisco International Airport in June 2015, compared to just one complaint for the entire year of 2014."
                />
                <TimelineElement
                    position='right'
                    background='rgb(33,150,243)'
                ...
                <TimelineElement
                    ...
                    date='Summer 2018'
                    description='ADS-B determines an aircraft position via satellite navigation or other sensors and periodically broadcasts that and other related data, enabling it to be tracked. It will soon become a very important device for communities impacted by aviation noise.'
                />
                <TimelineElement
                    position='right'
                    background='rgb(33,150,243)'
                ...
                <TimelineElement
                    ...
                    date='April 2023'
                    description='New/amended Q Routes and Y Routes replace the north-south high-altitude route structure along the east coast of the United States. In practice, 133 routes are consolidated, their altitudes changed, waypoints re-shuffled, and overall traffic shifted to cater for airlines fuel savings.'
                ...
                <TimelineElement
                    ...
                    date='September 2023'
                    description='Recent neighborhood noise study forces the FAA to set up a review of their outdated noise policy. Thousands of citizens leave comments denouncing the inadequacy of the DNL metric, mentioning failures to account for the changes happened in the last decades (ie NextGen). At the time of writing, results of the noise review are still to be published.'
                />
            </VerticalTimeline>
        </div>
      )  
