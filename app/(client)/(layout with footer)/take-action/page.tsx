    ...
    images: [
      {
        ...
        alt: 'Preview image for Take Action',
      },
    ],
  },
  twitter: {
        ...
        <div className="max-w-screen-xl px-4 pb-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-y-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <Card faviconFolder="action-favicons" favicon="Complaint favicon.png" altText="Complaints Section Icon" href="/take-action/log-complaints" title="Log Complaints" description="Complaints are crucial as they provide data that can drive legislative change and enforce regulations." />
              ...
              <Card faviconFolder="action-favicons" favicon="Legislation favicon.png" altText="Relevant Legislation Section Icon" href="/take-action/legislation" title="Legislation" description="A page that lists relevant legislation essential for combating aviation pollution and noise." />

              <Card faviconFolder="action-favicons" favicon="Groups favicon.png" altText="Join a Group Section Icon" href="/resources/useful-websites" title="Join a Group" description="Ready to jump in and give a hand? Join a local group. And join our Facebook page." />
            </div>
          </div>
        </div>
      </section>
