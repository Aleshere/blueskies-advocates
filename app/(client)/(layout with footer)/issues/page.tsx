        ...
        <div className="max-w-screen-xl px-4 pb-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-y-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/flight-paths">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/general-aviation">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/noise">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/pollution">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/economy-and-airports">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/greenwashing">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/myth-busters">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/helicopters">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/military-jets">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/private-jets">
                <span className="inline-block rounded-lg">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#f1f5f9] md:hover:dark:bg-[#314158] transition-colors focus:outline-none focus:ring" href="/issues/tours-and-skydiving">
                <span className="inline-block rounded-lg">
