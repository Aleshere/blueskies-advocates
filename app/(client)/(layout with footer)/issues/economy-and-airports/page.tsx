        ...
        <section id='airports-and-economy'>
            <div className="max-w-screen-xl px-4 pb-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-y-4">
                        ...
                        <p>
                          Instead of expanding airport capacity, funds could be invested in enhancing public transportation systems, such as high-speed rail networks, bus rapid transit (BRT) systems, and electric vehicle infrastructure. Efficient public transport reduces the need for short-haul flights, which are particularly carbon-intensive, and can alleviate traffic congestion and air pollution in urban areas. Example: In Europe, countries like France and Spain have developed extensive high-speed rail networks that connect major cities, reducing the need for domestic flights. This has led to a decrease in carbon emissions and has made travel more accessible and sustainable for residents and tourists alike.
                        </p>
