            ...
            <div className="max-w-screen-xl px-4 pb-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-y-4">
                        ...
                        <ul className='list-disc' >
                          <li>First, aviation is an industry that inevitably produces sound (in its negative inflection: noise): we use large engines or blades to lift up and carry metallic structures full of people and stuff against gravity. Until someone comes up with a different method to do that, there is no other way around it.</li>
                        ...
                        <p>
                          On the topic of noise and metrics, we highly recommend reading <a href="https://newsletters.cjscllc.com/p/colonial-patterns-aircraft-noise-part-1-issue-4" target="_blank" rel="noopener" >this</a> article. It was written by Chris Musei-Sequeira, who was the FAA HQ Environmental Protection Specialist from 2009 to 2016, before becoming a strong advocate for a more sustainable future in the sector. He talks about the ways the FAA deals with noise and community &quot;engagement&quot;.
                        </p>
                        ...
                        <ul className='list-disc' >
                          ...
                          <li><strong>London City Airport (LCY)</strong>: Closed between 12:30 pm on Saturday and 12:30 pm on Sunday (for 24 hours). Nightly closure from 10:00 pm to 6:30 am on weekdays. The airport strictly enforces its curfew to minimize noise in the densely populated areas surrounding it. In 2024 the airport applied to extend the closing time on Saturdays from 12:30pm to 6:30pm, with an additional hour for arriving flights only during the summer (up to 12 maximum flights). This <a href="https://www.flightglobal.com/air-transport/london-city-re-fleeting-argument-not-sufficient-to-lift-airports-weekend-curfew/159643.article" target="_blank" rel="noopener" >was rejected</a>, with the government saying that the removal of the curfew &quot;is not vital to unlock the potential for growth&quot;.</li>
                        </ul>
                        ...
                        <p>
                          <a href="https://www.alg-global.com/blog/aviation/noise-regulation-airports-european-union-and-differences-local-regulations" target="_blank" rel="noopener" >This website</a>, despite being a stated pro-aviation source, has a good overview of the Directive applications and noise measuring metrics used across various European Countries. 
                        </p>
                        ...
                        <p>
                          <strong>Dortmund Airport</strong> has a <a href="https://www.dortmund-airport.com/aviation/operating-data" target="_blank" rel="noopener" >curfew</a> in place: operating hours are from 6am to 10pm. However, an average of four landings per day are possible until 11pm in exceptional cases. In the event of unexcused delays, the exception permit even extends to 11:30pm. For take-offs, the permit provides times up to 10:30pm.
                        </p>
                        <p>
