        ...
        <section id="general-aviation" >
            <div className="max-w-screen-xl px-4 pb-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-y-8">
                        ...
                        <div className='link-wrap' >FAA accepts noise complaints at FAA Noise Portal. Only expect 1 response from FAA using this system even if multiple complaints are submitted. Per FAA&apos;s policy regarding the noise portal, FAA should release collected data quarterly. No data has been released since its inception which was FAA Reauthorization 2018: <a href="https://ancir.faa.gov/ancir?id=ancir_sc_cat_item&amp;sys_id=6149ade187a1f550b0d987b9cebb357e" target="_blank" rel="noopener" >https://ancir.faa.gov/ancir?id=ancir_sc_cat_item&amp;sys_id=6149ade187a1f550b0d987b9cebb357e</a>.</div>
                        <div className='link-wrap' >FAA Noise Ombudsman - it very difficult for communities to interact with FAA and few report receiving responses from FAA&apos;s ombudsman: <a href="https://www.faa.gov/about/office_org/headquarters_offices/apl/noise_emissions/airport_aircraft_noise_issues/n" target="_blank" rel="noopener" >https://www.faa.gov/about/office_org/headquarters_offices/apl/noise_emissions/airport_aircraft_noise_issues/noise_ombudsman</a>.</div>
                        <div className='link-wrap' >FAA also accepts safety complaints to its Hotline: <a href="https://www.faa.gov/about/office_org/headquarters_offices/aae/programs_services/faa_hotlines" target="_blank" rel="noopener" >https://www.faa.gov/about/office_org/headquarters_offices/aae/programs_services/faa_hotlines</a>.</div>
                        <div className='link-wrap' >FAA Part 150 - an expensive noise mapping process that can only establish voluntary suggestions for airports to use in order to alleviate noise: <a href="https://www.faa.gov/airports/resources/advisory_circulars/index.cfm/go/document.current/documentnumber/150_5020-1" target="_blank" rel="noopener" >https://www.faa.gov/airports/resources/advisory_circulars/index.cfm/go/document.current/documentnumber/150_5020-1</a>.</div>
                        ...
                        <div className='link-wrap' >National Parks on Noise: <a href="https://www.nps.gov/subjects/sound/overflights.htm" target="_blank" rel="noopener" >https://www.nps.gov/subjects/sound/overflights.htm</a>.</div>
                        ...
                        <div>On the issue of leaded fuel and its demise: <a href="https://mailchi.mp/adcbd07a22fb/the-time-is-now-ban-leaded-aviation-fuel-without-further-delay?e=9b75ea11d0" target="_blank" rel="noopener" >this</a>.</div>
