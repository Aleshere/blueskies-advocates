          ...
          <div className="grid grid-cols-1 gap-y-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#fff8dc] md:hover:dark:bg-gray-950 transition-colors focus:outline-none focus:ring" href="/resources/timeline">
                ...
                <p className="sm:mt-1 sm:block sm:text-sm text-gray-600 dark:text-gray-400">Timeline of the events that led to the current problems for communities impacted by consolidated flight paths: NextGen from its inception to today.</p>
              </a>
            </div>
          </div>
        </div>
