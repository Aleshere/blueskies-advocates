          ...
          <div className="grid grid-cols-1 gap-y-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#fff8dc] md:hover:dark:bg-gray-950 transition-colors focus:outline-none focus:ring" href="https://oregonaviationwatch.org/" target="_blank" rel="noreferrer noopener">
                ...
                <p className="sm:mt-1 sm:block sm:text-sm text-gray-600 dark:text-gray-400">Valuable blog and information about the need to research, educate and advocate on behalf of the public interest and public welfare about aviation issues.</p>
              </a>
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#fff8dc] md:hover:dark:bg-gray-950 transition-colors focus:outline-none focus:ring" href="https://planesoverlondon.com" target="_blank" rel="noreferrer noopener">
                ...
                <p className="sm:mt-1 sm:block sm:text-sm text-gray-600 dark:text-gray-400">
                  Planes Over London provides a 14-day forecast as to whether Heathrow arrivals will be flying their approach over London. It gives visitors a 14 day forecast and a live view of what&apos;s happening now. It shows the runway currently in use and it carefully tracks the number of
                  daily landing including delayed arrivals.
                </p>
              </a>
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#fff8dc] md:hover:dark:bg-gray-950 transition-colors focus:outline-none focus:ring" href="https://www.flightpathgc.com/" target="_blank" rel="noreferrer noopener">
                ...
                <p className="sm:mt-1 sm:block sm:text-sm text-gray-600 dark:text-gray-400">
                  Stop Flight Path Impacts - formerly known as Stop the ILS Flight Path - remains committed to what we&apos;ve always stood for; keeping the natural beauty of the Gold Coast, and the lifestyle it offers, protected from unnecessary noise and airborne pollution associated with Gold
                  Coast Airport.
                </p>
              </a>
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#fff8dc] md:hover:dark:bg-gray-950 transition-colors focus:outline-none focus:ring" href="http://www.stopairport.com/info/" target="_blank" rel="noreferrer noopener">
                ...
                <p className="sm:mt-1 sm:block sm:text-sm text-gray-600 dark:text-gray-400">We are uniformly opposed to any expansion of the runways at the Saratoga County Airport and this includes the no build option. We vote no to all proposals.</p>
              </a>
              ...
              <a className="block border border-gray-900 p-4 rounded-md shadow-sm md:hover:shadow-md md:hover:bg-[#fff8dc] md:hover:dark:bg-gray-950 transition-colors focus:outline-none focus:ring" href="https://www.uproarla.org/" target="_blank" rel="noreferrer noopener">
                ...
                <p className="sm:mt-1 sm:block sm:text-sm text-gray-600 dark:text-gray-400">UproarLA fights the FAA&apos;s &quot;Nextgen&quot; low altitude airplane flight paths at Hollywood Burbank Airport.</p>
              </a>
              ...
              >
                ...
                <p className="sm:mt-1 sm:block sm:text-sm text-gray-600 dark:text-gray-400">WWF was established in 1961 by a group of passionate and committed individuals who sought to secure the funding necessary to protect places and species that were threatened by human development.</p>
              </a>
            </div>
          </div>
        </div>
