        ...
        <div className="max-w-screen-xl px-4 pb-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-y-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <VideoCard
                favicon="AICA favicon.png"
                altText="CJSC, LLC YouTube Video Channel"
                href="https://www.youtube.com/watch?v=Pn-CEePmERg"
                title="Turbulence Ahead? Supreme Court Rulings & Environmental Law"
                description="Join this free webinar to learn about what Loper Bright and Corner Post might mean for legal challenges on aviation environmental issues, such as noise and air quality impacts. Our four panelists have extensive backgrounds in aviation law, environmental policy and compliance, and environmental advocacy."
                source="youtube"
              />
              ...
              <VideoCard favicon="Climate Adam favicon.jpg" altText="Climate Adam Channel YouTube" href="https://fb.watch/t54hcrBgrN/" title="Climate Adam" description="Flying is worse for the climate than you think." source="youtube" />
