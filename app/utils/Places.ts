...
export const Places: PlacesType = [
  ...
  },
  {
    ...
    information:
      'Citizens for Airpark Safety represents a group of community associations and concerned citizens in Montgomery County , Maryland who have committed to addressing the untenable, recurring, levels of airport noise, air pollution and flight safety risks imposed by the operations at Montgomery County Airpark',
  ...
  {
    id: 66,
    position: [28.24515, -80.7282],
    category: Category.CAT1,
    title: 'Quiet Skies Brevard County',
    information:
      'We are citizens who support reasonable regulations of aircraft noise and exhaust pollution. Aircraft noise can be reduced by restricting non-essential flight operations over residential neighborhoods and adopting stricter noise regulations. Leaded aviation gasoline that is used in small piston-engine planes should be replaced with a safer alternative',
  ...
  },
  {
    ...
    information:
      "A group of friends, neighbors and fellow citizens who believe strongly in the need of a viable, vigorous airport for service to the growing economy of the city, but are opposed to the expansion of our airport's aviation operations in the airport's current location which is the geographic and cultural heart of our growing city and totally atop the Edwards Recharge Zone",
  ...
  {
    id: 108,
    position: [42.46052, -71.3489],
    category: Category.CAT1,
    title: 'Quiet Communities',
    information:
      'Quiet Communities, a nonprofit 501(c)(3) organization, promotes quiet as a valuable natural resource and works to reduce harmful noise and related pollution. We take a collaborative, evidence-based, and solutions-driven approach aimed at engaging diverse stakeholders and finding common ground. At the core is a proven model of behavior change',
  ...
  {
    id: 112,
    position: [48.105, 16.5849],
    category: Category.CAT1,
    title: 'Aviation Reset',
    information:
      'The concept of unbridled growth as a motor for the economy - the credo of aviation for decades, hyped by politicians and the media - has had its day. The dream of cheap flights for everyone is not feasible. It is time for a reset, for a new beginning with a balanced approach that meets the challenges of our time',
  ...
  },
  {
    ...
    information:
      'The airport intends to align itself with the global growth of the sector, and expand to allow more passenger traffic. However, if we look more closely, this headlong rush, claimed by the promoter, will lead to a considerable increase in greenhouse gas emissions and global warming. In total contradiction with the Paris Agreement',
  ...
  },
  {
    ...
    website: 'www.weareblueskies.com/posts/rocky-mountain-Metropolitan-airport',
  ...
  {
    id: 260,
    position: [51.50014, -0.15311],
    category: Category.CAT1,
    title: 'Byway',
    information: 'Byway is the first 100% flight-free travel platform, creating customisable travel and accommodation packages away from the traditional tourist trails, using trains, buses and ferries, with on-demand support via WhatsApp throughout.',
    website: 'www.byway.travel/',
    favicon: 'Byway favicon.jpg',
    altText: 'Byway',
  },
  {
    id: 261,
    position: [46.23392, 6.10667],
    category: Category.CAT1,
    title: 'GVA Dictator Alert',
    information: 'Dictator Alert is a project that tracks the aircrafts of authoritarian regimes all over the world and runs several Twitter bots that announce when these aircrafts land in Paris, London, Geneva or the EuroAirport in Basel-Mulhouse-Freiburg.',
    website: 'dictatoralert.org/',
    favicon: 'GVA favicon.jpg',
    altText: 'GVA Dictator Alert',
  },
  {
    id: 262,
    position: [51.19893, 2.87324],
    category: Category.CAT1,
    title: 'WILOO',
    information: 'Working Group Impact #Luchthaven #Oostende on the Environment and #economie , #ethiek , and #milieu @wiloo@mastodon.vlaanderen.',
    website: 'x.com/wiloo_vzw',
    favicon: 'WILOO favicon.jpg',
    altText: 'WILOO X Channel',
  },
  {
    id: 263,
    position: [35.55872, 139.77949],
    category: Category.CAT1,
    title: '渋谷の空を守る会',
    information: 'Our association has been working to have the plans withdrawn, in order to protect the lives of residents from noise, falling debris, and air pollution caused by aircraft flying low over the city center.',
    website: 'x.com/SWC97514522',
    favicon: '渋谷の空を守る会 favicon.jpg',
    altText: '渋谷の空を守る会 X Channel',
  },
  {
    id: 264,
    position: [35.54059, 139.78111],
    category: Category.CAT1,
    title: '羽田問題訴訟の会',
    information: 'In March 2020, the route to Haneda Airport was changed, and planes began flying low over central Tokyo and Kawasaki City. Due to the noise and risk of accidents, we have filed a lawsuit against the government to have the route reverted.',
    website: 'x.com/8NweToenuldQKxS',
    favicon: '羽田問題訴訟の会 favicon.jpg',
    altText: '羽田問題訴訟の会 X Channel',
  },
  {
    id: 265,
    position: [35.68363, 139.75913],
    category: Category.CAT1,
    title: 'ヘリコプター・飛行機の騒音情報　in 東京',
    information: 'In recent years, there have been many complaints that the noise from helicopters and airplanes in Tokyo is terrible. I am just a resident of one ward, but I decided to provide information on how to get information about aircraft (mainly helicopters).',
    website: 'x.com/souonbokumetsu',
    favicon: 'ヘリコプター・飛行機の騒音情報　in 東京 favicon.jpg',
    altText: 'ヘリコプター・飛行機の騒音情報　in 東京 X Channel',
  },
  {
    id: 266,
    position: [35.55198, 139.76223],
    category: Category.CAT1,
    title: '飛行機雲見たか',
    information:
      "At Haneda Airport, the risk of landing at low altitudes over the city center is too high just to accommodate an increase of just 11,000 flights per year (2.4 %). The sudden attack by large aircraft creates feelings of anxiety, pressure, and disgust in the people's minds, and the safe and peaceful lives are destroyed by falling ice blocks, air pollution, noise, etc.",
    website: 'x.com/hikokigumomita5',
    favicon: '飛行機雲見たか favicon.jpg',
    altText: '飛行機雲見たか X Channel',
  },
  {
    id: 267,
    position: [35.56764, 139.74677],
    category: Category.CAT1,
    title: '羽田空港離着陸機に注目',
    information: 'I am keeping an eye on the planes taking off and landing at Haneda Airport and their routes. I am using flight radar. If a jet plane flies north at low altitudes over the 23 wards of Tokyo, I will  tweet a warning before it passes by, so please keep an eye on the sky.',
    website: 'x.com/haneda__rjtt',
    favicon: '羽田空港離着陸機に注目 favicon.jpg',
    altText: '羽田空港離着陸機に注目 X Channel',
  },
  {
    id: 268,
    position: [35.58587, 139.57573],
    category: Category.CAT1,
    title: '報道ヘリ通知',
    information: 'This bot notifies you of the news helicopters currently displayed by ADS-B Exchange every 5 to 15 minutes, mainly in the three major metropolitan areas.',
    website: 'x.com/jp_newsheli',
    favicon: '報道ヘリ通知 favicon.jpg',
    altText: '報道ヘリ通知 X Channel',
  },
  {
    id: 269,
    position: [35.60638, 139.76326],
    category: Category.CAT1,
    title: '都心低空飛行に反対',
    information: 'The construction, expansion, and offshore relocation of Haneda Airport have had a major impact on us, and our residents have resisted each time, enduring hardship. It will enter from the sea and exit from the sea. I want the government to keep that promise.',
    website: 'x.com/no_hanedazobin',
    favicon: '都心低空飛行に反対 favicon.jpg',
    altText: '都心低空飛行に反対 X Channel',
  },
  {
    id: 270,
    position: [38.70608, -8.97464],
    category: Category.CAT1,
    title: 'Aterra',
    information: 'ATERRA is the campaign to reduce air traffic, for fair mobility that respects the planet limits.',
    website: 'aterra.info/',
    favicon: 'aterra favicon.png',
    altText: 'Aterra Website',
  },
  {
    id: 271,
    position: [44.47274, -73.15317],
    category: Category.CAT1,
    title: 'Safe Landing BTV',
    information: 'It is time for a safe landing at Burlington International Airport. No expansion. 50% reduction of emissions by 2030',
    website: 'www.safelandingbtv.org/',
    favicon: 'Safe Landing BTV.jpg',
    altText: 'Safe Landing BTV Website',
  },
  {
    id: 272,
    position: [39.03615, -8.95424],
    category: Category.CAT1,
    title: 'Abolir Jatos',
    information: 'Abolir Jatos Privados. Jatos privados são a forma mais rápida e injusta de arder o nosso futuro.',
    website: 'x.com/AbolirJatos',
    favicon: 'Abolir Jatos favicon.jpg',
    altText: 'Abolir Jatos X Channel',
  },
  {
    id: 273,
    position: [39.55051, 2.72873],
    category: Category.CAT1,
    title: 'Plataforma contra ampliació de l aeroport de Palma',
    information: 'Platform of groups and individuals fighting against Aena intentions to expand Palma airport.',
    website: 'x.com/NoMesAvions',
    favicon: 'Plataforma Palma favicon.jpg',
    altText: 'Plataforma Palma X Channel',
  },
  {
    id: 274,
    position: [48.72359, 2.38027],
    category: Category.CAT1,
    title: 'SAM',
    information: 'STOP pollutions des avions de #ORLY.',
    website: 'x.com/SamSam94290',
    favicon: 'SAM favicon.jpg',
    altText: 'SAM X Channel',
  },
  {
    id: 275,
    position: [48.86234, 2.44122],
    category: Category.CAT1,
    title: 'Anne Bringault X Channel',
    information: 'Directrice des Programmes au Réseau Action Climat @RACFrance',
    website: 'twitter.com/AnneBringault',
    favicon: 'Bringault favicon.png',
    altText: 'Anne Bringault X Channel',
  },
  {
    id: 276,
    position: [48.85545, 2.3373],
    category: Category.CAT1,
    title: 'Sarah Fayolle X Channel',
    information: 'Pétrole, Transports, Pollution Air @greenpeacefr',
    website: 'twitter.com/SarahFayolle',
    favicon: 'Fayolle favicon.jpg',
    altText: 'Sarah Fayolle X Channel',
  },
  {
    id: 277,
    position: [48.86766, 2.3057],
    category: Category.CAT1,
    title: 'Alexis Chailloux X Channel',
    information: 'Responsable aérien et ferroviaire au @RACFrance (ex @greenpeacefr) Engagé pour des voyages décarbonés',
    website: 'twitter.com/achamish',
  ...
  {
    id: 279,
    position: [41.95838, -70.66739],
    category: Category.CAT1,
    title: 'Take Back Our Plymouth Airport ',
    information: 'Stop the Plymouth Airport Expansion. It is NOT for safety! Bring Plymouth Airport back to its roots as a recreational airport without jets.',
    website: 'www.takebackourplymouthairport.org',
    favicon: 'Take Back Plymouth favicon.jpg',
    altText: 'Take Back Our Plymouth Airport',
  },
  {
    id: 280,
    position: [42.34749, -83.4572],
    category: Category.CAT1,
    title: 'Close 1D2',
    information: 'The mission statement and single goal of the close1d2.org web site is about protecting children from lead poisoning.',
    website: 'close1d2.org',
    favicon: '1D2 favicon.png',
    altText: 'Close 1D2',
  },
  {
    id: 281,
    position: [19.73981, -99.01489],
    category: Category.CAT1,
    title: '12 Pueblos Originarios de Tecamac',
    information: 'The corporate purpose of this page is to know the past, present and future of the 12 towns.',
    website: 'www.facebook.com/profile.php?id=100067454349134',
    favicon: '12 Pueblos favicon.jpg',
    altText: '12 Pueblos Originarios de Tecamac',
  },
  {
    id: 282,
    position: [13.19682, -87.96086],
    category: Category.CAT1,
    title: 'Mala Yerba',
    information: 'La MalaYerba is a Central American journalistic project producer specializing in environmental journalism.',
    website: 'mala-yerba.com',
    favicon: 'Mala Yerba favicon.jpg',
    altText: 'Mala Yerba',
  },
  {
    id: 283,
    position: [-13.3963, -72.05367],
    category: Category.CAT1,
    title: 'Salvemos Chinchero',
    information: 'Taking action against irreversible damage to national heritage and the environment caused by Chinchero Airport.',
    website: 'www.facebook.com/salvemoschinchero',
    favicon: 'Salvemos Chinchero favicon.jpg',
    altText: 'Salvemos Chinchero',
  },
  {
    id: 284,
    position: [52.12086, 20.47237],
    category: Category.CAT1,
    title: 'Stowarzyszenie Zanim Powstanie Lotnisko',
    information: 'We are a non-governmental organization focused mainly on activities aimed at protecting the interests of residents from the areas covered by the planned investment called the Central Communication Port together with the accompanying infrastructure.',
    website: 'www.zpl-cpk.pl',
    favicon: 'Stowarzyszenie Zanim Powstanie Lotnisko favicon.png',
    altText: 'Stowarzyszenie Zanim Powstanie Lotnisko',
  },
  {
    id: 285,
    position: [52.12339, 20.47615],
    category: Category.CAT1,
    title: 'Nie Dla Projectow CPK w Calej Polsce',
    information: 'The overscaled projects of the CPK, especially the concept of a mega-airport, are not milestones of development, but stones for the development of our country.',
    website: 'www.facebook.com/groups/NieDlaCPK',
    favicon: 'Nie Dla Projectow CPK w Calej Polsce favicon.png',
    altText: 'Nie Dla Projectow CPK w Calej Polsce',
  },
  {
    id: 286,
    position: [51.39989, -3.33915],
    category: Category.CAT1,
    title: 'Vale Communities Unite Against the planned development of Model Farm',
    information: 'Community group set up for people to come together to oppose L&G plans to destroy our local area. This is a speculative development with no investors interested, no demand from the airport, and no future prospects.',
    website: 'www.facebook.com/groups/2430462787280026',
    favicon: 'Default favicon.png',
    altText: 'Vale Communities Unite Against the planned development of Model Farm',
  },
];
